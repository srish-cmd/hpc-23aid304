...
#
#     ./selfcheck.sh                # tests reduction.c in this folder
...
SRC="${1:-starter/reduction.c}"
[ -f "$SRC" ] || SRC="reduction.c"
[ -f "$SRC" ] || { echo "no source file found (looked for starter/reduction.c and reduction.c)"; exit 1; }
